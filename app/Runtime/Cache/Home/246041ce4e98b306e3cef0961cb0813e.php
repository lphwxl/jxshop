...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('CSS');?>/list.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo C('JS');?>/list.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
	...
	<div class="list w1210 bc mt10">
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
				<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><li>
						<dl>
							<dt><a href="<?php echo U('detail','goods_id='.$good['goods_id']);?>"><img src="<?php echo ($good['goods_small_logo']); ?>" alt="商品图标" /></a></dt>
							<dd><a href="<?php echo U('detail','goods_id='.$good['goods_id']);?>"><?php echo ($good['goods_name']); ?></a></dt>
