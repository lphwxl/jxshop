...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('CSS');?>/home.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('CSS');?>/user.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo C('JS');?>/home.js"></script>
</head>
<body>
		<!-- 顶部导航 start -->
	<div class="topnav">
