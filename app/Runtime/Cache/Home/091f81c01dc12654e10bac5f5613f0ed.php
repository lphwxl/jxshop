				...
				<div class="preview fl">
					<div class="midpic">
						<a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo C('IMG');?>/preview_m1.jpg" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="<?php echo C('IMG');?>/preview_s1.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><img src="<?php echo C('IMG');?>/preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m4.jpg',largeimage: 'images/preview_l4.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m5.jpg',largeimage: 'images/preview_l5.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m6.jpg',largeimage: 'images/preview_l6.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m7.jpg',largeimage: 'images/preview_l7.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m8.jpg',largeimage: 'images/preview_l8.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m9.jpg',largeimage: 'images/preview_l9.jpg'}">  
	    							<img src="<?php echo C('IMG');?>/preview_s9.jpg"></a>
								</li>
							</ul>
						</div>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="<?php echo C('IMG');?>/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG');?>/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
