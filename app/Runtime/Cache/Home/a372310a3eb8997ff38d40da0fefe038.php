...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('CSS');?>/goods.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('CSS');?>/common.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('CSS');?>/bottomnav.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('CSS');?>/footer.css" type="text/css">
	
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="<?php echo C('CSS');?>/jqzoom.css" type="text/css">

	<script type="text/javascript" src="<?php echo C('JS');?>/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="<?php echo C('JS');?>/header.js"></script>
	<script type="text/javascript" src="<?php echo C('JS');?>/goods.js"></script>
	<script type="text/javascript" src="<?php echo C('JS');?>/jqzoom-core.js"></script>
	<style type="text/css">
		/*购物车弹出框*/
		.orange{color: #CC0000;}
		a.bt_orange:link,a.bt_orange:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(<?php echo C('IMG');?>/chakanBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer; display:block; _display:inline; float:left; margin-left:60px;}
		a.bt_blue:link,a.bt_blue:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(<?php echo C('IMG');?>/tiaoxuannBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer;display:block;_display:inline; float:right; margin-right:60px;}
		...
		.buy_blank h4{ border-bottom:2px solid #D0D0D0; font-weight:normal; height:30px; line-height:30px;background:url(<?php echo C('IMG');?>/buyicon.jpg) no-repeat 10px center; text-indent:28px; margin-bottom:10px; padding-left:20px;}
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<dl>
						<dt><a href=""><img src="<?php echo C('IMG');?>/hpG4.jpg" alt="" /></a></dt>
						<dd><a href="">惠普G4-1332TX 14英寸笔记...</a></dd>
					</dl>

					<dl class="last">
						<dt><a href=""><img src="<?php echo C('IMG');?>/crazy4.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong id="goods_name"><?php echo ($goodone['goods_name']); ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo ($pics[0]['pics_big']); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo ($pics[0]['pics_mid']); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
	
					<!--使用说明：此处的预览图效果有三种类型的图片，大图，中图，和小图，取得图片之后，
					分配到模板的时候，把第一幅图片分配到 上面的midpic 中，其中大图分配到 a 标签的href属性，
					中图分配到 img 的src上。
					 下面的smallpic 则表示小图区域，
					格式固定，在 a 标签的 rel属性中，分别指定了中图（smallimage）和大图（largeimage），img标签则显示小图，按此格式循环生成即可，但在第一个li上，要加上cur类，同时在第一个li 的a标签中，添加类 zoomThumbActive  -->
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
							<?php if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($i % 2 );++$i; if(($i) == "0"): ?><li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($pic['pics_mid']); ?>',largeimage: '<?php echo ($pic['pics_big']); ?>'}"><img src="<?php echo ($pic['pics_sma']); ?>"></a>
								</li>
							<?php else: ?>
									<li >
									<a  href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($pic['pics_mid']); ?>',largeimage: '<?php echo ($pic['pics_big']); ?>'}"><img src="<?php echo ($pic['pics_sma']); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo ($goodone['goods_id']); ?></li>
						<li class="market_price"><span>定价：</span><em>￥<?php echo ($goodone['goods_price']+200); ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<em style="font-style:normal;" id="goods_price"><?php echo ($goodone['goods_price']); ?><em></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo date('Y-m-d',$goodone['add_time']);?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
						<?php if(is_array($manyAttr)): foreach($manyAttr as $k=>$attrs): ?><li class="product">
								<dl>
									<dt><?php echo ($attrs['attr_name']); ?>：</dt><?php echo ($k1); ?>
									<dd>
									<?php if(is_array($attrs['attr_values'])): foreach($attrs['attr_values'] as $kk=>$attr): if(($kk) == "0"): ?><a class="selected" href="javascript:;" ><?php echo ($attr); ?><input type="radio" name="color" value="<?php echo ($kk); ?>" checked="checked" /></a>
									<?php else: ?>
										<a href="javascript:;" ><?php echo ($attr); ?><input type="radio" name="color" value="<?php echo ($kk); ?>" /></a><?php endif; endforeach; endif; ?>
									</dd>
								</dl>
						...
						<li>
							<dl>
								...
								<dd>
									...
									<input type="text" name="amount" value="1" class="amount" id="amount"/>
						...
						<li>
							<dl>
								<dt>&nbsp;</dt>
								<dd>
									<input type=button value="" class="add_btn" id="add_btn" onclick="commit(<?php echo ($goodone['goods_id']); ?>)"/>
								</dd>
							</dl>
						</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<li><span>商品名称：</span><?php echo ($goodone['goods_name']); ?></li>
								<li><span>商品编号：</span><?php echo ($goodone['goods_id']); ?></li>
								<li><span>品牌：</span>魅族</li>
								<li><span>上架时间：</span><?php echo date('Y-m-d H:i:s',$goodone['add_time']);?></li>
								<li><span>商品毛重：</span><?php echo ($goodone['goods_weight']); ?>kg</li>
								<li><span>商品产地：</span>中国大陆</li>
								<?php if(is_array($attrone)): $i = 0; $__LIST__ = $attrone;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span data-id="<?php echo ($vo['attr_id']); ?>"><?php echo ($vo['attr_name']); ?>：</span><?php echo ($vo['attr_value']); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
						...
						<div class="desc mt10">
							...
							<p style="height:auto;">
							<?php echo ($goodone['goods_introduce']); ?>
							</p>
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
...
<!-- 底部版权 start -->
	...
	<script type="text/javascript">
		...
		function commit(goods_id){
			var num = $('#amount').val();
			var goods_name = $('#goods_name').text();
			var obj = $('#add_btn');
			var x = obj.offset().left-$('html,body').scrollLeft();
			var y = obj.offset().top - $('html,body').scrollTop();
			var goods_price = $('#goods_price').text();
			$.ajax({
				url:'<?php echo U('shop/addgoods');?>',
				data:{'goods_id':goods_id,'num':num,'goods_price':goods_price,'goods_name':goods_name},
				type:'post',
				success:function(msg){
					$('#cartBox').css({'left':(x+57)+'px','top':(y+60)+'px'});
					$('#cartBox').show(500);
					var msg = eval('('+msg+')');
...
<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
    <h4>
        <span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="<?php echo C('IMG');?>/close.jpg" title="点击关闭"/></a></span>
        该商品已成功添加到购物车
    </h4>
