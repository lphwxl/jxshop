...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('CSS');?>/index.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo C('JS');?>/index.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="<?php echo C('IMG');?>/index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="<?php echo C('IMG');?>/ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="<?php echo C('IMG');?>/holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="<?php echo C('IMG');?>/scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="<?php echo C('IMG');?>/lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="<?php echo C('IMG');?>/sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo C('IMG');?>/taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo C('IMG');?>/wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/crazy1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/crazy2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/crazy3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/crazy5.jpg" alt="" /></a></dt>
				...
				<div class="hot none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/hot2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/hot3.jpg" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/recommend1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/recommend2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/recommend3.jpg" alt="" /></a></dt>
				...
				<div class="new none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/new1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/new2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/new3.jpg" alt="" /></a></dt>
				...
				<div class="guess none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/guess1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/guess2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMG');?>/guess3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="<?php echo C('IMG');?>/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="<?php echo C('IMG');?>/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="<?php echo C('IMG');?>/notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMG');?>/qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="<?php echo C('IMG');?>/dell.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/acer.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMG');?>/intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="<?php echo C('IMG');?>/canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
