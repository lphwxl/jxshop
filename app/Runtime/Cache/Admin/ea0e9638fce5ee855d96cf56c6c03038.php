...
.STYLE6 {olor: gray; font-size: 16px; }
.STYLE10 {olor: gray; font-size: 14px; }
.STYLE19 {
	color: gray;
	font-size: 16px;
}
    ...
    <td>
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="" >
	      <tr>
	        ...
	        <input type="text" style="width:94%;" name="goods_name" /><span style="color:red;"><?php if(isset($msg["goods_name"])): echo ($msg['goods_name']); endif; ?></span>
	        </div></td>
	      </tr>
	      <tr>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">* 价格：</span></div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="goods_price" /><span style="color:red;"><?php if(isset($msg["goods_price"])): echo ($msg['goods_price']); endif; ?><span></span></div></td>
	      </tr>
	      <tr>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">* 数量：</span></div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="goods_number" /><span style='color:red;'><?php if(isset($msg["goods_number"])): echo ($msg['goods_number']); endif; ?></span></div></td>
	      </tr>
	      <tr>
	      ...
	      <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="" id="mix-tab-show" style="display:none;">
		      <tr>
		        ...
		        <textarea rows="5" cols="20" style='width:800px;height:100px;' name="goods_introduce" id="goods_introduce"></textarea>
		        </div></td>
		      </tr>
	    </table>
		  <!-- 详情描述 结束 -->    
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#fff" id="properties-tab-show" style="display:none;">
		       ...
		       <tr id='nav' style="height:40px;">
			        ...
			        <td height="20" bgcolor="#fff" class="STYLE19" style="padding-left:20px;">
			       		 <div align="left">
			       		 	<select name="type_id" onchange='detal(this)'>
...
<script type="text/javascript">
	...
	$(function(){
		...
		oAdd.click(function(){
			$str = '<tr class="nav"><td class="dete_tr"><span style="margin:4px 10px;cursor:pointer" class="delete">[ - ]</span></td><td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">商品相册</span></div></td> <td height="20" bgcolor="#FFFFFF" class="STYLE19" ><input type="file" name="big_'+(++i)+'"/><div align="left"></div></td></tr>';
			oTr.append($str);
	...
	function detal(param){
		...
		{
			$.ajax({
				url:'/index.php/Admin/Goods/getattr/type_id/'+id,
				type:'get',
				async:false,
				success:function(msg){
					...
					if(len == 0)
					{
						...
						for(var i=0;i<len;i++){
							...
							if(msg[i].attr_sel == 'only' && msg[i].attr_write== 'manual'){
							...
							}else  if(msg[i].attr_sel=='many' && msg[i].attr_write=='list'){
