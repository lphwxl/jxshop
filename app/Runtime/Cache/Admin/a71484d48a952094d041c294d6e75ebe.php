          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 管理员管理 -> 管理员列表</span></td>
              </tr>
            </table></td>
    ...
    <td>
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	      <tr>
	        ...
	        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">用户名称</span></div></td>
	        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">用户角色</span></div></td>
	      ...
	      <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
	        ...
	        <td height="40" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($info['id']); ?></span></div></td>
	        <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['user']); ?></div></td>
	        <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['role_name']); ?></div></td>
	        <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['role_auth_ids']); ?></div></td>
	        <?php if(($info["id"]) != "1"): ?><td height="20" style="width:60px;" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
	        <img src="<?php echo C('AD_IMG');?>/del.gif" width="10" height="10" /> <button style='color:gray;'  data-id="<?php echo ($info['id']); ?>" class="delete">删除 </button>| <a href="<?php echo U('show','id='.$info['id']);?>" style="color:gray;">查看</a> | <img src="<?php echo C('AD_IMG');?>/edit.gif" width="10" height="10" /> <button type="button" class='btn' onclick='javascript:window.location.href="/admin/manager/update/id/<?php echo ($info['id']); ?>"' style="cursor:pointer;outline:none;border:none;">编辑</button></div></td><?php endif; ?>
