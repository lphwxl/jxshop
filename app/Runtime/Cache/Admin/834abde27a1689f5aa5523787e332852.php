        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              <a href="<?php echo U('Goods/tianjia');?>"><img src="<?php echo C('AD_IMG');?>/add.gif" width="10" height="10" /> 添加</a>   &nbsp; 
              </span>
    ...
    <td>
	    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	      <tr>
	        ...
	        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">品牌名称</span></div></td>
	        ...
	        <td width="12%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">重量</span></div></td>
	        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">大图</span></div></td>
	      ...
	      <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
	        ...
	        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($info['goods_name']); ?></span></div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['goods_price']); ?></div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['goods_number']); ?></div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['goods_weight']); ?></div></td>
	        <td height="20"  width='40' style="width:40px;height:20px;" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><img src="<?php echo ($info['goods_big_logo']); ?>" width="40"/></div></td>
<!-- 	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><img src="<?php echo ($info['goods_small_logo']); ?>" width="20"/></div></td>
 -->	        <td height="20" style="width:60px;" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
	        <img src="<?php echo C('AD_IMG');?>/del.gif" width="10" height="10" /> 删除 | 查看 | <img src="<?php echo C('AD_IMG');?>/edit.gif" width="10" height="10" /> <button type="button" class='btn' onclick='javascript:window.location.href="/admin/goods/update/id/<?php echo ($info['goods_id']); ?>"' style="cursor:pointer;outline:none;border:none;">编辑</button></div></td>
