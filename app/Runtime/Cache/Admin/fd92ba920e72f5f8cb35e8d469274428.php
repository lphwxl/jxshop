        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              <a href="<?php echo U('tianjia');?>"><img src="<?php echo C('AD_IMG');?>/add.gif" width="10" height="10" /> 添加类型</a>   &nbsp; 
              </span>
    ...
    <td>
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	      ...
	      <?php if(empty($result)): ?><tr>
	        	<td height="40" bgcolor="#FFFFFF" colspan="4">
	        		<div align="center">
	          		暂无数据
	       			 </div>
	        	</td>
	      ...
	      <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
	        ...
	        <td height="40" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($info['type_id']); ?></span></div></td>
	        <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($info['type_name']); ?></div></td>
	        <td height="20" style="width:60px;" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
	        <a href="<?php echo U('attribute/showlist','type_id='.$info['type_id']);?>" style="color:gray;font-size:14px;" >属性列表</a>
	         | <img src="<?php echo C('AD_IMG');?>/del.gif" width="10" height="10" /> <button style='color:gray;'  data-id="<?php echo ($info['type_id']); ?>" class="delete">删除 </button>| <a href="<?php echo U('show','id='.$info['type_id']);?>" style="color:gray;">查看</a> | <img src="<?php echo C('AD_IMG');?>/edit.gif" width="10" height="10" /> <button type="button" class='btn' onclick='javascript:window.location.href="/admin/type/update/id/<?php echo ($info['type_id']); ?>"' style="cursor:pointer;outline:none;border:none;">编辑</button></div></td>
			...
			if($(this).index() === 0){
				...
				$.ajax({
					...
					success:function(msg){
						var msg = eval('('+msg+')');
						msg.error?window.obj.parent().parent().parent().remove():alert('删除失败');
					},
				});
